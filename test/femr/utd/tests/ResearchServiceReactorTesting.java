 ...
 */
public class ResearchServiceReactorTesting extends BaseTest {
    ...
    public static void initialize(){
        System.out.println("Testing Research Service!!");
        cleanDB();
    }
    ...
    @Test
    public void testRetrServicevalue(){

        //create the medication
        ServiceResponse<MedicationItem> response = service.createMedication("Medication 1", "formtest", null);

        ResearchServiceRefactor researchServiceRefactor = response.getClass().newInstance();
        if(researchServiceRefactor == null){
           assertFalse();
        }eles {
            assertFalse();
        }
